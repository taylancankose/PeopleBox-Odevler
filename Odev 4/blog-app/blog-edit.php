<?php
    ...
    if ($_SERVER["REQUEST_METHOD"]=="POST") {
        ...
        if(editBlog($id,$title,$description,$image,$url,$isActive)){
            echo "<div class='alert alert-success mb-0 text-center'>Başarıyla düzeltildi</div>";
            header('Location: index.php');
        }else{
            echo "<div class='alert alert-danger mb-0 text-center'>Blog düzenlenirken bir hata oluştu</div>";
        }
    }
?>
